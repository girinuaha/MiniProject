	                      ...
	                      <tbody>
	                      	<c:forEach var="customer" items="${customers }">
								<tr>
									...
									<td>
										<button class="btn btn-warning btn-sm update-btn icon-box" data-id="${customer.id}" title="Update"><span class="icons icon-note"></span></button>&nbsp;
										<button class="btn btn-danger btn-sm delete-btn icon-box" data-id="${customer.id}" title="Delete"><span class="icons icon-trash"></span></button>
									</td>
								</tr>
							</c:forEach>
	                      </tbody>
