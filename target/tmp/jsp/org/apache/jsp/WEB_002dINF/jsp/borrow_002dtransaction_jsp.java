 ...
 * Generated at: 2017-11-05 02:16:07 UTC
...
public final class borrow_002dtransaction_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>Library MASA | Borrow Transaction</title>\n");
      out.write("\n");
      out.write("  <!-- start: Css -->\n");
      ...
      out.write("                    <div class=\"panel-body\">\n");
      out.write("                    \t<form action=\"borrow_transaction/save\" method=\"POST\" id=\"borrowForm\">\n");
      ...
      out.write("\t\t\t\t\t\t\t    \t<select class=\"form-control employee\" name=\"employee.id\" style=\"width: 100%;\">\n");
      out.write("\t\t\t\t\t\t\t    \t<option></option>\n");
      out.write("\t\t\t\t\t\t\t    \t\t");
      ...
      out.write("\t\t\t\t\t\t\t\t  \t<div class=\"col-md-11 book\">\n");
      out.write("\t\t\t\t\t\t\t\t  \t\t<label>Book</label>\n");
      out.write("\t\t\t\t\t\t\t\t\t    <select class=\"form-control bookTransaction\" name=\"bookTransaction.book[0].id\" style=\"width: 100%;\">\n");
      out.write("\t\t\t\t\t\t\t\t\t    \t<option></option>\n");
      out.write("\t\t\t\t\t\t\t\t    \t\t");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-success addButton\"><i class=\"fa fa-plus\"></i></button><br><br>\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group hide\" id=\"bookTemplate\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-md-11 book\">\n");
      out.write("\t\t\t\t\t\t\t\t\t    <select class=\"form-control\" name=\"bookTransaction.book.id\">\n");
      out.write("\t\t\t\t\t\t\t\t\t    \t<option></option>\n");
      out.write("\t\t\t\t\t\t\t\t    \t\t");
      ...
      out.write("\t\t\t\t\t\t\t\t  \t</div>\n");
      out.write("\t\t\t\t\t\t\t\t  \t<div class=\"col-md-1\">\n");
      out.write("\t\t\t\t\t\t\t            <button type=\"button\" class=\"btn btn-danger removeButton\"><i class=\"fa fa-minus\"></i></button><br><br>\n");
      out.write("\t\t\t\t\t\t\t        </div>\n");
      out.write("\t\t\t\t\t\t\t    </div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group col-md-6\">\n");
      ...
      out.write("\t    var bookIndex = 0;\n");
      out.write("\t\n");
      out.write("\t    $('#borrowForm')\n");
      out.write("\t        // Add button click handler\n");
      out.write("\t        .on('click', '.addButton', function() {\n");
      out.write("\t        \tbookIndex++;\n");
      out.write("\t            var $template = $('#bookTemplate'),\n");
      out.write("\t                $clone    = $template\n");
      out.write("\t                                .clone()\n");
      out.write("\t                                .removeClass('hide')\n");
      out.write("\t                                .removeAttr('id')\n");
      out.write("\t                                .attr('data-book-index', bookIndex)\n");
      out.write("\t                                .insertBefore($template);\n");
      out.write("\t\n");
      out.write("\t            // Update the name attributes\n");
      out.write("\t            $clone\n");
      out.write("\t                .find('[name=\"bookTransaction.book.id\"]').attr('name', 'bookTransaction.book[' + bookIndex + '].id').end()\n");
      out.write("\t                .find('[name=\"bookTransaction.book['+bookIndex+'].id\"]').select2({\n");
      ...
      out.write("\t                index = $row.attr('data-book-index');\n");
      out.write("\t            \n");
      out.write("\t            // Remove element containing the fields\n");
      out.write("\t            $row.remove();\n");
      out.write("\t        });\n");
      out.write("\t    \n");
      out.write("\t   $(\"#bookTransaction['+bookIndex+'].id\").select2({\n");
      out.write("            placeholder: \"Select a book\",\n");
      out.write("            allowClear: true\n");
      out.write("        }); \n");
      out.write("\t});\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/jsp/borrow-transaction.jsp(162,13) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f1.setVar("employee");
      // /WEB-INF/jsp/borrow-transaction.jsp(162,13) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f1.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/jsp/borrow-transaction.jsp(162,13) '${employees }'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${employees }",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
  ...
  private boolean _jspx_meth_c_005fforEach_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/jsp/borrow-transaction.jsp(172,14) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f2.setVar("book");
      // /WEB-INF/jsp/borrow-transaction.jsp(172,14) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f2.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/jsp/borrow-transaction.jsp(172,14) '${books }'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${books }",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
  ...
  private boolean _jspx_meth_c_005fforEach_005f3(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/jsp/borrow-transaction.jsp(186,14) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f3.setVar("book");
      // /WEB-INF/jsp/borrow-transaction.jsp(186,14) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f3.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/jsp/borrow-transaction.jsp(186,14) '${books }'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${books }",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
