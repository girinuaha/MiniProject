 ...
 * Generated at: 2017-11-04 15:50:16 UTC
...
public final class borrow_002dtransaction_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t    <select class=\"form-control bookTransaction\" name=\"bookTransaction[0].id\" style=\"width: 100%;\">\n");
      out.write("\t\t\t\t\t\t\t\t\t    \t<option></option>\n");
      out.write("\t\t\t\t\t\t\t\t    \t\t");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-md-11 book\">\n");
      out.write("\t\t\t\t\t\t\t\t\t    <select class=\"form-control\" name=\"bookTransaction.id\">\n");
      out.write("\t\t\t\t\t\t\t\t\t    \t<option></option>\n");
      out.write("\t\t\t\t\t\t\t\t    \t\t");
      ...
      out.write("\t            $clone\n");
      out.write("\t                .find('[name=\"bookTransaction.id\"]').attr('name', 'bookTransaction[' + bookIndex + '].id').end()\n");
      out.write("\t                .find('[name=\"bookTransaction['+bookIndex+'].id\"]').select2({\n");
